      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <a 
            ...
            className="group block bg-white/10 dark:bg-white/5 backdrop-blur-lg rounded-2xl p-8 hover:bg-white/20 dark:hover:bg-white/10 transition-all duration-300 hover:scale-105 hover:shadow-2xl border border-white/20 dark:border-white/10"
          >
            <div className="flex items-center mb-6">
              <span className="text-6xl mr-4">⚾</span>
              <div>
                <h2 className="text-3xl font-bold text-white group-hover:text-blue-300 dark:group-hover:text-blue-400 transition-colors">
                  Baseball Dashboard
                </h2>
                <p className="text-gray-300 dark:text-gray-400">Daily Fantasy Baseball Intelligence</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-white/20 dark:border-white/10">
              <span className="text-sm text-gray-400 dark:text-gray-500">Powered by MLB Stats API + Statcast</span>
          ...
          >
            <div className="flex items-center mb-6">
              <span className="text-6xl mr-4">🏈</span>
              <div>
                <h2 className="text-3xl font-bold text-white group-hover:text-green-300 dark:group-hover:text-green-400 transition-colors">
                  ESPN Recap Generator
                </h2>
                <p className="text-gray-300 dark:text-gray-400">AI-Powered Weekly Recaps</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-white/20 dark:border-white/10">
              <span className="text-sm text-gray-400 dark:text-gray-500">Powered by Claude AI + ESPN API</span>
              <span className="text-white group-hover:translate-x-2 transition-transform">→</span>
            </div>
          </a>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center space-x-8 bg-white/10 dark:bg-white/5 backdrop-blur-lg rounded-full px-8 py-4 border border-white/20 dark:border-white/10">
        ...
        {/* Footer */}
        <footer className="mt-16 text-center text-gray-400 dark:text-gray-500">
